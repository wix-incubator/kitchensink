...
export function MembersPage({
  ...
  const daysMember = member?._createdDate
    ? Math.floor(
        (Date.now() - new Date(member._createdDate).getTime()) /
          (1000 * 60 * 60 * 24)
      )
    : 0;
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8 flex-1 flex flex-col">
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-white/70 text-lg mb-6 max-w-md">
              We're working on exciting new features for our members. Stay tuned
              for updates!
            </p>
            ...
            <div className="grid grid-cols-1 gap-4 w-full max-w-sm">
              <div className="bg-white/5 rounded-xl p-4 backdrop-blur-sm border border-white/10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-medium">Member Analytics</h3>
              ...
              <div className="bg-white/5 rounded-xl p-4 backdrop-blur-sm border border-white/10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/50 text-sm">Connect with others</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 rounded-xl p-4 backdrop-blur-sm border border-white/10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/50 text-sm">Exclusive benefits</p>
                  </div>
                </div>
              </div>
            </div>
