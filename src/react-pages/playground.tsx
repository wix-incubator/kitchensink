...
const dummyProducts: ProductData[] = [
  { id: '1', name: 'Awesome T-Shirt', price: 25.0 },
  { id: '2', name: 'Cool Jeans', price: 50.0 },
  { id: '3', name: 'Fancy Hat', price: 15.0 },
  { id: '4', name: 'Vintage T-Shirt', price: 30.0 },
  { id: '5', name: 'Modern Jacket', price: 75.0 },
];
...
const useProductListContext = () => {
  ...
  if (!context)
    throw new Error(
      'This component must be wrapped inside <ProductList.Root />'
    );
  return context;
};
...
const useProductContext = () => {
  ...
  if (!context)
    throw new Error(
      'Product components must be wrapped inside <Product.Root />'
    );
  return context;
};
  ...
  Info: ({ className, ...props }: { className?: string }) => {
    ...
    const text =
      count === originalCount
        ...
        : `Showing ${count} of ${originalCount} products`;
    return (
