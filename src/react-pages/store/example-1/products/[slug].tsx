...
export default function ProductDetailPage({
  ...
  let servicesMap = createServicesMap()
    ...
    .addService(SeoTagsServiceDefinition, SeoTagsService, seoTagsServiceConfig);
    ...
    <ServicesManagerProvider servicesManager={servicesManager}>
      <BaseLayout
        head={
          <>
            <title>
              {productServiceConfig.product.name} - Store - Kitchensink
            </title>
            <meta
              name="description"
              content={`View details for ${productServiceConfig.product.name}`}
            />
          </>
        }
        body={
