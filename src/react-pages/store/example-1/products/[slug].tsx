...
const FreeTextInput = ({ 
  ...
  <ProductModifiers.FreeText modifier={modifier}>
    {withDocsWrapper(
      ({ 
        ...
        <div className="space-y-2">
          <textarea
            ...
            placeholder={freeTextPlaceholder || `Enter custom ${name.toLowerCase()}...`}
            maxLength={maxChars}
          ...
          />
          {maxChars && (
            <div className={`text-xs text-right ${isOverLimit ? 'text-[var(--theme-text-error)]' : 'text-[var(--theme-text-content-60)]'}`}>
      ...
      "/docs/components/product-modifiers#modifier-free-text"
    )}
  </ProductModifiers.FreeText>
);
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                                    ...
                                    ({ 
                                      ...
                                      <div className="space-y-3">
                                        <h4 className="text-md font-medium text-[var(--theme-text-content)]">
                                          {name} {mandatory && <span className="text-[var(--theme-text-error)]">*</span>}
                                        </h4>
                                        
                                        {type === "SWATCH_CHOICES" && hasChoices && (
                                          <div className="flex flex-wrap gap-2">
                                            {choices.map((choice: any) => (
                                              <ProductModifiers.Choice key={choice.value} modifier={modifier} choice={choice}>
                                                {withDocsWrapper(
                                                  ({ value, isSelected, colorCode, onSelect }) => (
                                                    <button
                                                      ...
                                                      style={{
                                                        backgroundColor: colorCode || "var(--theme-text-content-40)",
                                                      }}
                                                      title={value}
                                                    />
                                                  ),
                                                  ...
                                                  ({ isTextInputShown, onToggle }) => (
                                                    <div className="space-y-3">
                                                      <label className="flex items-center gap-2">
                                                        ...
                                                        />
                                                        <span className="text-[var(--theme-text-content)]">Enable</span>
                                                      </label>
                                                      {isTextInputShown && (
                                                        <FreeTextInput modifier={modifier} name={name} />
                                                      )}
                ...
                {/* Quantity Selector */}
                <div className="space-y-3">
                  <h3 className="text-lg font-semibold text-[var(--theme-text-content)]">Quantity</h3>
                        ...
                        <div className="space-y-4">
                          {error && (
                            <div className="bg-[var(--theme-text-error)]/10 border border-[var(--theme-text-error)]/20 rounded-lg p-3">
                              <p className="text-[var(--theme-text-error)] text-sm">{error}</p>
                            </div>
                          )}
                          ...
                          <button
                            ...
                            style={{
                              background: canAddToCart ? 'var(--theme-btn-primary)' : 'var(--theme-bg-options)',
                              cursor: !canAddToCart || isLoading ? 'not-allowed' : 'pointer'
                            }}
                            onMouseEnter={(e) => {
                        ...
                        <div className="flex items-center gap-2">
                          <div
                            className={`w-3 h-3 rounded-full ${
                              inStock ? "bg-[var(--theme-text-success)]" : "bg-[var(--theme-text-error)]"
                            }`}
                          ></div>
                          <span
                            className={`text-sm ${
                              inStock ? "text-[var(--theme-text-success)]" : "text-[var(--theme-text-error)]"
                            }`}
                          >
                            {status}
