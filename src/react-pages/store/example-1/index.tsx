                                  ...
                                  {withDocsWrapper(
                                    ({
                                      ...
                                      <div className="bg-[var(--theme-bg-card)] backdrop-blur-sm rounded-xl p-4 border border-[var(--theme-border-card)] hover:border-[var(--theme-border-card-hover)] transition-all duration-200 hover:scale-105 group h-full flex flex-col">
                                        <div className="aspect-square bg-[var(--theme-bg-options)] rounded-lg mb-4 overflow-hidden">
                                          {image ? (
                                            <WixMediaImage
                                              media={{ image: image }}
                ...
                {hasProducts && totalProducts > 0 && (
                  <div className="text-center mt-12">
                    <button
                      onClick={loadMore}
                      disabled={isLoading}
                      className="text-[var(--theme-text-content)] font-semibold py-3 px-8 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 mx-auto"
                      style={{
                    ...
                    >
                      {isLoading ? (
                        <>
                          <svg
                            className="animate-spin -ml-1 mr-3 h-5 w-5 text-[var(--theme-text-content)]"
