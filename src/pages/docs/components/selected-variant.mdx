        ...
        <div className="spec-group">
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="font-medium">
                {hasWeight ? weight : 'Not specified'}
              </span>
            </div>
          </div>
        </div>
...
import type {
  ...
  DetailsProps,
  DetailsRenderProps,
} from '../headless/store/components/SelectedVariant';
```
  ...
  {({ sku, weight, hasSku, hasWeight }) => (
    <div className="product-details" role="region" aria-labelledby="details-heading">
      ...
      <dl>
        <div>
          <dt>SKU:</dt>
          <dd aria-label={`Product SKU: ${hasSku ? sku : 'Not available'}`}>
            {hasSku ? sku : "N/A"}
          </dd>
        </div>
        <div>
          <dt>Weight:</dt>
          <dd aria-label={`Product weight: ${hasWeight ? weight : 'Not specified'}`}>
            {hasWeight ? weight : "N/A"}
          </dd>
        </div>
      </dl>
    </div>
