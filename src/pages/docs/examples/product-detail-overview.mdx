...
- **CurrentCart.OpenTrigger** - Cart icon trigger with item count
- **CurrentCart.Content** - Cart modal/drawer with state management
- **CurrentCart.LineItemsList** - Cart items list
- **CurrentCart.Item** - Individual cart item management
- **CurrentCart.Summary** - Cart totals and summary
