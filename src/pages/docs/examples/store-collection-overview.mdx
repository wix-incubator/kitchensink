...
- **CurrentCart.OpenTrigger** - Cart icon trigger with live item count
- **CurrentCart.Content** - Cart modal/drawer with state management
- **CurrentCart.LineItemsList** - List of items in cart
- **CurrentCart.Item** - Individual cart item with quantity controls
- **CurrentCart.Summary** - Cart totals, pricing, and checkout availability
- **CurrentCart.Checkout** - Checkout initiation button
- **CurrentCart.EmptyState** - Empty cart display
- **CurrentCart.Clear** - Clear all cart items functionality
- **CurrentCart.Notes** - Order notes management
- **CurrentCart.Coupon** - Coupon code application
