...
export default function WixServicesLayout({ children, showCartIcon = false }: WixServicesLayoutProps) {
    ...
    .addService(ProductMediaGalleryServiceDefinition, ProductMediaGalleryService)
