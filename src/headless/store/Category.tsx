...
import { CategoryServiceDefinition, type CategoryServiceAPI } from "./category-service";
...
export const CategoryList: React.FC<CategoryListProps> = ({ children }) => {
  ...
  const [selectedCategory, setSelectedCategory] = useState<string | null>(service.selectedCategory.get());
