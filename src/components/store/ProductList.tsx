    ...
    <CurrentCart.Root currentCartServiceConfig={currentCartServiceConfig}>
      <TooltipProvider>
        <ProductList productsListConfig={productsListConfig}>
          <div className={cn(className, 'min-h-screen')} id={id}>
            {/* Header Controls */}
            ...
            <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
              ...
              <div className="flex-1 min-w-0">
                <>
                  ...
                  <Products>
                    <ProductRepeater>
                      <Card className="product-item relative hover:shadow-lg transition-all duration-200 hover:scale-105 group h-full flex flex-col bg-surface-card border-surface-subtle justify-between">
                        {/* Product Ribbon */}
                        <ProductRibbon />
                        <CardContent className="p-4 pb-0">
                          {/* Product Image */}
                          <div className="aspect-square bg-surface-primary rounded-lg mb-4 overflow-hidden relative product-image">
                            <ProductMediaGallery>
                          ...
                          <ProductSlug asChild>
                            {({ slug }) => (
                              ...
                              >
                                <CardTitle className="text-primary mb-2 line-clamp-2 hover:text-brand-primary transition-colors product-title">
